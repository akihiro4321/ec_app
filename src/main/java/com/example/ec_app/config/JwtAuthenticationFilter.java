...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(final HttpServletRequest request,
        ...
        try {
            ...
            final AuthorizationErrorResponse errorRes =
                    new AuthorizationErrorResponse(request.getRequestURI());
            final HttpHeaders headers = new HttpHeaders();
            headers.setContentType(MediaType.APPLICATION_JSON);
            final ResponseEntity<ApiErrorResponse> errorEntity =
                    new ResponseEntity<>(errorRes, headers, HttpStatus.UNAUTHORIZED);
